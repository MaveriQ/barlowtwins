...
class DataCollatorForBarlowBertWithMLM:
    ...
    def __call__(
        ...
        batch["input_ids"] = self.mask_tokens(batch["input_ids"], special_tokens_mask=special_tokens_mask)
        batches.append(batch)
        batch_1["input_ids"] = self.mask_tokens(batch_1["input_ids"], special_tokens_mask=special_tokens_mask)
